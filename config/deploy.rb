...
set :application, "Papiamentu_Frontend"
set :domain,      "YOURSERVER"
set :user,        "YOURUSER"
...
set :repository,  "file:///home/#{user}/#{application}.git"
set :local_repository, "ssh://#{user}@#{domain}/home/#{user}/#{application}.git"
set :scm,         "git"
